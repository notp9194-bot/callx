...
public final class ItemMessageReceivedBinding implements ViewBinding {
  ...
  private ItemMessageReceivedBinding(@NonNull LinearLayout rootView,
      @NonNull ImageButton btnPlayAudio, @NonNull FrameLayout flVideo, @NonNull ImageView ivImage,
      ...
      @NonNull TextView tvFileName, @NonNull TextView tvMessage, @NonNull TextView tvSenderName,
  ...
  public static ItemMessageReceivedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageReceivedBinding((LinearLayout) rootView, btnPlayAudio, flVideo, ivImage,
          ivVideoThumb, llAudio, llFile, seekAudio, tvAudioDur, tvFileMeta, tvFileName, tvMessage,
          tvSenderName, tvTime);
    }
