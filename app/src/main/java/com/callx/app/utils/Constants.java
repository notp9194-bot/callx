...
public class Constants {
    ...
    // Group keys — direct chats vs group chats ke saare notifications
    // alag-alag stack me bundle hote hain (WhatsApp style).
    ...
    // Group action intents (handled by NotificationActionReceiver)
